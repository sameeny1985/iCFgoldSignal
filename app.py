...
STO_OVERBUY_CRS = float(os.getenv("STO_OVERBUY_CRS", "70"))
STO_OVERSELL_CRS = float(os.getenv("STO_OVERSELL_CRS", "30"))

STO_OVERBUY_EXT = float(os.getenv("STO_OVERBUY_EXT", "80"))
STO_OVERSELL_EXT = float(os.getenv("STO_OVERSELL_EXT", "20"))
